...
@NamedQuery(name = "adresse.findAdresse", query = "SELECT a FROM Adresse a")
@NamedQuery(name = "adresse.findAdresseByPk", query = "SELECT a FROM Adresse a WHERE a.pk LIKE :pk")
